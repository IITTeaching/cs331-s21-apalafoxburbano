...
def gen_pattern(chars):
    numLetters = len(chars)*2-1
    numDot = numLetters-1
    total = numLetters + numDot  
    for x in range(len(chars)-1, -1, -1):
      lastLetter = chars[x:]
      for y in range(x+1, len(chars)):
        lastLetter = chars[y] + lastLetter
      lastLetter = '.'.join(lastLetter)
      line = lastLetter.center(total,'.')
      print(line)
    for z in range(1, len(chars)):
      end = chars[z:]
      for b in range(z+1, len(chars)):
        end = chars[b] + end
      end = '.'.join(end)
      line = end.center(total,'.')
      print(line)
